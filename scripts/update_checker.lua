...
UpdateChecker = {
    ...
    new = function ()
        ...
        instance.AVATAR_NAME = "StrawberryMiku"
        instance.BRANCH_NAME = ""
        instance.CONFIG_NAME = "update_cache_strawberrymiku"
        instance.REPOSITORY_NAME = "Gakuto1112/StrawberryMiku"
    ...
    init = function (self)
        if host:isHost() then
            ...
            --アクションホイールへの登録
            action_wheel:setPage(action_wheel:newPage():setAction(1, self:getUpdateAction()))
    ...
    getUpdateAction = function (self)
        ...
        self.updateAction:setItem("minecraft:compass"):setOnLeftClick(function ()
            ...
            if self.latestVersion ~= nil and self.currentTime < self.lastCheckTime + 86400000 then
                host:setClipboard("https://github.com/"..self.REPOSITORY_NAME.."/releases/tag/"..self.latestVersion)
